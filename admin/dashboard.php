            ...
            <div class="row">
              <div class="col">
                <div class="h-100">
                    ...
                    <div class="col-12">
                      ...
                      >
                        <div class="flex-grow-1">
                          <h4 class="fs-16 mb-1">Good Morning, <?php echo $_SESSION['login_user'] ?>!</h4>
                  ...
                  <?php
                  $crud = new crud();
                  $result = $crud->selectsingledata("select (select count(*) from services) as 'SerCount'");
                 ?>
                  <div class="row">
